  ...
  render() {
    return (
      <div>
        ...
        <p>
          Нас тут двое (Андрей и Лина). Мы любим ввязываться в сотню авантюр и
          ещё любим котиков (=^.^=).
        </p>
        <p>
        ...
        <p>
          Тут мы отпускаем в вольное плавание по просторам интернета наши отчеты
          о поездках, делимся фотографиями, даем советы, от которых бы не
          отказались сами до поездки.
        </p>
        ...
        <p>
          А что за название странное? Долго мы о нем не думали, оно к нам
          влетело стремительно и покорило нас своей нелепостью. Олейник и Лось?
          Очевидно же, "ОЛОЛОСЬ"!
        </p>
        <p>
