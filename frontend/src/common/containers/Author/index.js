  ...
  render() {
    ...
    const authorHelmet = {
      ...
      meta: [
        ...
        { name: "twitter:description", property: "og:description", content: authorName },
    ...
    return (
      <div className="container" style={style}>
        ...
        />
        <br />
        Когда-то здесь будет красивая страничка с нашими фотографиями и ссылками на наши тви и инста аккаунты, а пока
        вот вам сухая информация.
        <br />
...
function mapStateToProps(state, ownProps) {
  return {
    author: getById(authorsSelector(state), ownProps.params.id, Constants.EMPTY_AUTHOR)
  };
}
